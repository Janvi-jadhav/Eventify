  ...
  return (
    <div className="font-display bg-background-light dark:bg-background-dark min-h-screen">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <h1 className="text-4xl font-extrabold text-slate-900 dark:text-slate-100 mb-4">My Events</h1>
        <p className="text-slate-600 dark:text-slate-400">Add your saved events here</p>
      </main>
